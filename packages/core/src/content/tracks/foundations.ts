      ...
      lessons: [
        ...
        lesson({
          ...
          steps: [
            ...
            trueFalse(
              'On small tabular datasets, gradient-boosted trees routinely beat neural networks.',
              true,
              ['sk-ai-ml-dl-relationship'],
              'They do, and it is not close. Trees handle mixed types and missing values natively, train in seconds, and need no architecture search. Deep learning earns its keep where the data has structure to exploit — images, audio, language. Pick the method that fits the data you actually have.',
            ),
          ],
        }),
    ...
    // -----------------------------------------------------------------------
    {
      ...
      lessons: [
        ...
        lesson({
          ...
          steps: [
            ...
            trueFalse(
              'A forecasting model should be tested on a later period than the one it was trained on.',
              true,
              ['sk-data-leakage', 'sk-train-val-test'],
              'Always. A random split lets the model train on future data and predict the past, which is impossible at deployment, and the accuracy it reports can never be reproduced in production. Split chronologically: train on the earlier period, test on the later one.',
            ),
            numeric(
      ...
      checkpoint: {
        ...
        exercises: [
          ...
          trueFalse(
            'Unsupervised learning finds structure without any labelled examples.',
            true,
            ['sk-unsupervised-learning'],
            'That is the defining property. Clustering, dimensionality reduction and density estimation all work from the shape of the data alone, which is why they are reached for when labels are expensive or do not exist.',
          ),
        ],
      },
    },
