      ...
      lessons: [
        ...
        lesson({
          ...
          steps: [
            ...
            trueFalse(
              'Reproducing a training run needs the data version and the environment, not just the code.',
              true,
              ['sk-experiment-tracking'],
              'Code is one of four moving parts. Data version, configuration and environment each change results independently, and none of them live in the code repository by default.',
            ),
          ],
        }),
      ],
      ...
      lessons: [
        ...
        lesson({
          ...
          steps: [
            ...
            trueFalse(
              'A few ordinary attributes such as postcode, birth date and sex can re-identify most people.',
              true,
              ['sk-privacy'],
              'The remaining fields act as a fingerprint, and re-identification against a public dataset is a well-established attack — the Netflix Prize data being the textbook case. Stripping direct identifiers is the beginning of anonymisation, not the end of it.',
            ),
            multi(
      ...
      lessons: [
        ...
        lesson({
          ...
          steps: [
            ...
            trueFalse(
              'Q-learning can learn about the greedy policy while acting on a different, exploratory one.',
              true,
              ['sk-q-learning'],
